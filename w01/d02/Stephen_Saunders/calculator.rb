...
while initializer != "q"
	...
	elsif initializer == "cos"
		cos_num = Math.cos(trig_num)
		puts "The #{initializer} of #{trig_num} is #{cos_num}."

	# this is the tangent function
	elsif initializer == "tan"
		tan_num = Math.tan(trig_num)
		puts "The #{initializer} of #{trig_num} is #{tan_num}."
