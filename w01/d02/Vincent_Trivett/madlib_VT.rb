...
template = "Last week I got hit by a #{noun} while I was trying to #{verb}. It felt #{adj}. The #{noun} #{verb}ed me most #{adv}. It took #{num} days to recover. My brother brought me a #{noun2} while I was at the hospital. As it happened, I gave birth to a child named #{name.capitalize}."
