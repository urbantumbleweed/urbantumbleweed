...
# Create a new array whose elements are capitalized versions of the corresponding elements of the 
#first array. (Go check out #capitalize in the Ruby docs!)
...
create an escape while user enters q 

		enter strings to new array

	end


take same array and capitialize each value

while array.each |x, y| { x, y puts "" }